                    ...
                    <>
                        <div className="flex justify-center mt-5">
                            <div className="flex flex-col rounded-lg shadow-lg bg-white max-w-sm">
                                <iframe height="260" src={`https://www.youtube.com/embed/${id}`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                                <div className="p-6">
